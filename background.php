...
<head>
	...
	<title>WebMS | Company Background</title>
</head>
<body>
	<?php
	...
	<div id="sidebar" class="s-panel">
		...
		<div class="s-panel-o">
			...
			<ul type="none">
				<li><a href="background.php" class="s-panel-o-active"><i class="fa fa-globe"></i>Company Background</a></li>
	...
	<div id="content" class="c-panel">
		<div class="c-panel-h">
			...
			<ul type="none">
				...
				<li><a href="#"><i class="fa fa-comment"></i> Conversation</a></li>
			</ul>
		</div>
	</div>
</body>
